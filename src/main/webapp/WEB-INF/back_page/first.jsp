...
<SCRIPT type="text/javascript">
	...
	$(function() {//预加载方法
		...
		$('#tabs').tabs('add', {
			title : '欢迎使用',
			content : createFrame('/system/welcome.do')
		}).tabs({
	...
	function modifyPassword() {
		createmodalwindow("修改密码", 500, 200,
				'/teacher/orTeacher/myselfInfo/toModifyPassword.do');
	}
</SCRIPT>
...
<BODY style="overflow-y: hidden;" class="easyui-layout" scroll="no">
	<DIV
		...
		<SPAN style="padding-right: 20px; float: right;" class="head">
			欢迎当前用户：${sessionScope.teacher_session.teacher.teacherName}&nbsp;&nbsp;
			<A href=javascript:showhelp()>使用帮助</A> &nbsp;&nbsp; <A title='修改密码'
			href="javascript:modifyPassword()" icon='icon-null' id="modifypwd">修改密码</A>
