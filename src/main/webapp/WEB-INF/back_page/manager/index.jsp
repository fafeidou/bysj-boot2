	...
	<div class="wrapper">
			...
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<c:if test="${sessionScope.manager_session != null}">
							<li class="dropdown user user-menu"><a href="#">
									欢迎管理员${sessionScope.manager_session.name}登录 </a>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="#"> <i
							class="fa fa-pie-chart"></i> <span>院系管理</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a href="/manage/department/toAdd.do" target="content"><i
									class="fa fa-circle-o"></i>添加院系</a></li>
							<li class="active"><a href="/manage/department/toEdit.do"
								target="content"><i class="fa fa-circle-o"></i>编辑院系信息</a></li>
						</ul></li>
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-pie-chart"></i> <span>教师管理</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a href="/manage/teacher/toAdd.do" target="content"><i
									class="fa fa-circle-o"></i>添加老师</a></li>
							<li><a href="/manage/teacher/toEdit.do" target="content"><i
									class="fa fa-circle-o"></i>编辑教师信息</a></li>
						</ul></li>


					<li class="treeview"><a href="#"> <i
							class="fa fa-pie-chart"></i> <span>权限管理</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a href="/manage/role/toAssignRoles.do" target="content"><i
									class="fa fa-circle-o"></i>教师分配角色</a></li>
						</ul></li>
		...
		<div class="content-wrapper" style="background: grey">
			<iframe id="content" name="content"
				...
				src="/manage/department/toEdit.do"></iframe>
		</div>
		<!-- /.content-wrapper -->
