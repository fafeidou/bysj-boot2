...
<script type="text/javascript">
	...
	var columns_v = [ [
			...
			},
			{
				...
				width : 90,
				formatter : function(value, row, index) {
					return "<a href=javascript:choiceThesistopic('"
							+ row.thesistopic.thesisTopicId + "')>选择</a>";
				}
			} ] ];
	...
	$(function() {
		$('#sysuserlist').datagrid({
			...
			striped : true,//条纹显示效果
			url : '/student/thesistopicManage/listAllThesistopic.do',//加载数据的连接，引连接请求过来是json数据
	...
	function viewDetails(id) {
		...
		createmodalwindow("课题详细信息", 500, 600,
				'/student/thesistopicManage/viewDetails.do?thesisTopicId='
						+ id);
	}
	//学生选课题
	function choiceThesistopic(id) {
		_confirm(
				'您确认选该论文么？',
				null,
				function() {
					var url = "/student/thesistopicManage/choiceThesistopic.do";
					var params = {
						"thesisTopicId" : id
					};
		...
		<TABLE class="table_search" style="margin-left: 6px">
			<TBODY>
				<TR>
					...
					<td><select id="" name="graduationYear"
						style="width: 100px">
							<option value="2016届">2016届</option>
							<option value="2017届">2016届</option>
					</select></td>
