...
<script type="text/javascript">
	...
	$(function() {
		$('#sysuserlist').datagrid({
			...
			striped : true,//条纹显示效果
			url : '/teacher/trDirector/thesistopicManage/listThesistopic.do',//加载数据的连接，引连接请求过来是json数据
	...
	function viewDetails(id) {
		...
		createmodalwindow("课题详细信息", 500, 600,
				'/teacher/trDirector/thesistopicManage/viewDetails.do?thesisTopicId='
						+ id);
	}
	//审核课题
	function specifieTrDirector(id) {
		//打开修改窗口
		createmodalwindow("审核课题", 400, 200,
				'/teacher/trDirector/thesistopicManage/toReviewThesistopic.do?thesisTopicId='
						+ id);
	}
</script>
