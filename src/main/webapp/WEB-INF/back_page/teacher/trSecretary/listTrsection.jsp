...
<script type="text/javascript">
	...
	var columns_v = [ [ {
		...
		formatter : function(value, row, index) {
			return "<a href=javascript:deleteTrsection('"+row.trsectionId+"')>删除</a>";
		}
	}, {
		field : 'opt2',
		title : '操作',
		width : 90,
		formatter : function(value, row, index) {
			return "<a href=javascript:toEditTrsection('"+row.trsectionId+"')>修改</a>";
		}
	}] ];
	...
	var toolbar_v = [ {//工具栏
		...
		handler : function() {
			...
			createmodalwindow("添加教研室", 800, 250, '/teacher/trSecretary/toAddTrsection.do');
		}
	} ];
	...
	$(function() {
		$('#sysuserlist').datagrid({
			...
			striped : true,//条纹显示效果
			url : '/teacher/trSecretary/listTrsection.do',//加载数据的连接，引连接请求过来是json数据
	...
	function deleteTrsection(id){
		...
		_confirm('您确认删除吗？',null,function (){
			...
			jquerySubByFId('trsectiondeleteform',userdel_callback,null,"json");
	...
	function toEditTrsection(id){
		//打开修改窗口
		createmodalwindow("修改教研室信息", 800, 250, '/teacher/trSecretary/toEditTrsection.do?trsectionId='+id);
	}
</script>
...
<form id="trsectiondeleteform" action="/teacher/trSecretary/deleteTrsection.do" method="post">
